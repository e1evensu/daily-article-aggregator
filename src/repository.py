...
class ArticleRepository:
    ...
    def init_db(self):
        ...
        cursor.execute(
            "CREATE INDEX IF NOT EXISTS idx_is_pushed ON articles(is_pushed)"
        )
    ...
    def get_unpushed_articles(self) -> list[dict[str, Any]]:
        ...
        cursor.execute(
            "SELECT * FROM articles WHERE is_pushed = 0 ORDER BY fetched_at DESC"
        )
        rows = cursor.fetchall()
